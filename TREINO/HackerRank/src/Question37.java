...
public class Question37 {
	...
	public static void main(String[] args)throws IOException {
		...
		while(n > 0) {
			...
			System.out.println(a < 38 || a % 5 < 3 ? a : a + (5 - (a % 5)));
			n--;
		}
	}
}
...
1.Student 1 received a 73, and the next multiple of 5 from 73 is 75. Since 75-73 < 3, 
the student's grade is rounded to 75.
2.Student 2 received a 67, and the next multiple of 5 from 67 is 70. Since , the grade
will not be modified and the student's final grade is 67.
