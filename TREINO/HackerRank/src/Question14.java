...
constant or as some kind of variable." — Wikipedia: String (computer 
science).
...
For the second line, write Yes if is A lexicographically greater than B otherwise 
print No instead.
...
When sorted alphabetically/lexicographically, "hello" precedes "java"; therefore, A is 
not greater than B and the answer is No.
