...
If B<=0 or H<=0, the output should be "java.lang.Exception: Breadth and height 
...
-100<=H<=100
          Output Format
If both values are greater than zero, then the main method must output the area
