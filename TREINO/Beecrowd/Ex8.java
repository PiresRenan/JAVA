...
public class Ex8 {
    ...
    public static void main(String[] args) {
        ...
        float vRecebidoH = sc.nextFloat();
        float SalarioFinal = vRecebidoH * hTrabalhadas ;
        sc.close();

        System.out.printf("NUMBER = " + nFuncionario + "%n" + "SALARY = US$ %.2f %n" , SalarioFinal);
...
com um espaço em branco antes e depois da igualdade. No caso do salário, também deve haver um 
